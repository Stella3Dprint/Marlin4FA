...
void GcodeSuite::G34() {
  ...
  // STELLAMOVE
    ...
    do { // break out on error
      ...
      float z_auto_align_amplification = TERN(HAS_Z_STEPPER_ALIGN_STEPPER_XY, Z_STEPPER_ALIGN_AMP, parser.floatval('A', Z_STEPPER_ALIGN_AMP));
      // iter_N++;
      // if (iter_N == 1) {
      //   z_auto_align_amplification = 1.2f;
      // }
      // else if (iter_N == 2) {
      //   z_auto_align_amplification = 1.0f;
      // } 
      // else if (iter_N == 3) {
      //   z_auto_align_amplification = 0.8f;
      // } 
      // else if (iter_N == 4) {
      //   z_auto_align_amplification = 0.6f;
      // } 
      // else if (iter_N == 5) {
      //   z_auto_align_amplification = 0.4f;
      // }       
      // if (!WITHIN(ABS(z_auto_align_amplification), 0.2f, 2.0f)) {        
      //   SERIAL_ECHOLNPGM("?(A)mplification out of bounds (0.2-2.0).");
      //   break;
      // }
      if (!WITHIN(ABS(z_auto_align_amplification), 0.2f, 2.0f)) {        
      ...
      while (iteration < z_auto_align_iterations) {
        ...
        LOOP_L_N(zstepper, NUM_Z_STEPPERS) {
          ...
          const float z_align_abs = ABS(z_align_move);
            ...
            #if ENABLED(STM_FA400)
            if (iteration == 1) amplification  = 1.3f;
            else if (iteration == 2) amplification  = 1.0f;
            else if (iteration == 3) amplification  = 0.9f;
            else if (iteration == 4) amplification  = 0.8f;
            else if (iteration == 5) amplification  = 0.7f;
            else amplification = 0.5f;
            #endif 
