...
// STELLAMOVE
  ...
  #define THERMAL_PROTECTION_PERIOD 120 //90        // Seconds
   ...
   */
  // STELLAMOVE
  #define WATCH_TEMP_PERIOD  120 //90               // Seconds
...
// STELLAMOVE
   ...
   */
// STELLAMOVE
  #define WATCH_BED_TEMP_PERIOD               300 //240 // Seconds
...
// STELLAMOVE
#if ENABLED(STM_FA400_S42B)
  #define MINIMUM_STEPPER_PULSE 3  // S42B
#else
  #define MINIMUM_STEPPER_PULSE 0  // TMC2209
#endif
...
// STELLAMOVE
#if ENABLED(STM_FA400_S42B)
  #define MAXIMUM_STEPPER_RATE 150000   // S42B
#else
  #define MAXIMUM_STEPPER_RATE 5000000  // TMC2209
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           90  // 45  // (seconds) Time limit before the nozzle is turned off for safety.
 ...
 */
  ...
  // STELLAMOVE
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       400        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #if AXIS_IS_TMC(Z2)
    #define Z2_CURRENT       400        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #if AXIS_IS_TMC(Z3)
    #define Z3_CURRENT       400        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #if AXIS_IS_TMC(Z4)
    #define Z4_CURRENT       400        // (mA) RMS current. Multiply by 1.414 for peak current.
