...
// STELLAMOVE
#define STRING_CONFIG_H_AUTHOR "(Stellamove, FA400)" // Who made the changes.
...
// @section stellamove machine
// STELLAMOVE
#define STM_FA400
#define STM_FA400_PITTA               // PITTA
...
// STELLAMOVE
#if ENABLED(STM_FA400_PITTA)
  #define CUSTOM_MACHINE_NAME "FA400"
#else
  #define CUSTOM_MACHINE_NAME "FA400"
#endif
...
#endif
#define Z_DRIVER_TYPE  TMC2209  // Front-Left
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2209  // Rear-Left
#define Z3_DRIVER_TYPE TMC2209  // Rear-Right
#define Z4_DRIVER_TYPE TMC2209  // Front-Right
...
/**
 * When use S42B
 * S42B  8 subdivision(2048 pulse) : Default * 0.64 (2048/3200)
 * S42B 16 subdivision(4096 pulse) : Default * 1.28 (4096/3200)
 * S42B 32 subdivision(8192 pulse) : Default * 2.56 (8192/3200)
 */
 ...
 */
// STELLAMOVE
#define DEFAULT_MAX_FEEDRATE          { 2500, 2500, 30, 500 }  // { 500, 500, 10, 100 }
...
// STELLAMOVE
#if ENABLED(STM_FA400_S42B)
  #define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 5000 }  // S42B
#else
  #define DEFAULT_MAX_ACCELERATION      { 10000, 10000, 500, 10000 }  // { 5000, 5000, 100, 10000 }  // TMC2209
#endif
 ...
 */
// STELLAMOVE
#define DEFAULT_ACCELERATION                  4500  // 3000 // X, Y, Z ... and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION          4500  // 3000 // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION           4500  // 3000 // X, Y, Z ... acceleration for travel (non printing) moves
 ...
 */
// STELLAMOVE
#define Z_MIN_PROBE_PIN Z_MIN_PIN  // PA3 // Z_MAX_PIN
...
// STELLAMOVE
#define XY_PROBE_FEEDRATE (250*100)

// STELLAMOVE
// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST 1000 //(4*250)//4*70

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW 170 //(Z_PROBE_FEEDRATE_FAST / 4)
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE  5 //5 // Z Clearance for Deploy/Stow
#define Z_CLEARANCE_BETWEEN_PROBES  5//5 // Z Clearance between probe points
...
// STELLAMOVE
#define X_BED_SIZE 400  // 400
#define Y_BED_SIZE 400  // 400
